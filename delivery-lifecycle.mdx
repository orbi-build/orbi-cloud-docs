...
The page has **Copy link** and **Share on X** buttons. For a public repository anyone with the link can open it; for a private repository it only opens for someone signed in to the owning Orbi account, so sharing the link does not expose private code.
