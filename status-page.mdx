...
![The full status page for an active tenant](/images/status-active.png)
...
![The status page for a brand-new tenant, before a repository is connected](/images/status-new-tenant.png)
...
![The status page at phone width](/images/status-active-mobile.png)
