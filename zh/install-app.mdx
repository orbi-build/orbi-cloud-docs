...
第一次登录后，Orbi 会显示 **连接仓库** (Connect repository) 页，告诉你已登录，但 Orbi 还没装到任何仓库。在那里点 **把 Orbi 装到你的仓库** (Install Orbi on your repository)，以后也可以在状态页上点 **连接仓库**，都会把你送到 GitHub 的安装页。（如果你是从 orbi.build 上的注册按钮进来的，可能一开始就会看到这个页面。）
